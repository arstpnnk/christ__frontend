...
const samplePrayerMorning = [
  "Утренняя молитва",
  "",
  "Во имя Отца и Сына и Святого Духа. Аминь.",
  "",
  "Господи, благодарю Тебя за эту ночь и за новый день. Даруй мне силы и разум,",
  "сохрани меня от зла и научи жить по Твоей воле.",
  "",
  "Благослови мои мысли, слова и дела. Помоги быть внимательным к людям,",
  "терпеливым в трудностях и благодарным в радости.",
  "",
  "Храни мою семью и близких, направляй меня на путь добра.",
  "",
  "Господи Иисусе Христе, Сыне Божий, помилуй меня грешного(ую). Аминь.",
];

const samplePrayerEvening = [
  "Вечерняя молитва",
  "",
  "Во имя Отца и Сына и Святого Духа. Аминь.",
  "",
  "Господи, благодарю Тебя за прожитый день. Прости меня за все мои грехи,",
  "вольные и невольные — словом, делом и помышлением.",
  "",
  "Даруй мне мирный сон и сохрани меня от всякого зла. Укрепи мою веру,",
  "дай чистоту сердцу и кротость душе.",
  "",
  "Поручаю Тебе себя и всех моих близких. Да будет воля Твоя. Аминь.",
];

const samplePrayerFood = [
  "Молитва перед едой",
  "",
  "Господи, благослови пищу и питие рабов Твоих,",
  "и сделай нас достойными Твоих благодеяний.",
  "",
  "Благодарим Тебя, Христе Боже наш,",
  "что насытил нас земными благами; не лиши нас и Царствия Небесного. Аминь.",
];
...
export default function BookReaderScreen({ route }: { route: BookReaderRoute }) {
  ...
  const { headerTitle, lines } = useMemo(() => {
    ...
    if (bookId === "prayer_morning") {
      return { headerTitle: "Утренняя молитва", lines: samplePrayerMorning };
    }
    if (bookId === "prayer_evening") {
      return { headerTitle: "Вечерняя молитва", lines: samplePrayerEvening };
    }
    if (bookId === "prayer_food") {
      return { headerTitle: "Молитва перед едой", lines: samplePrayerFood };
    }
    if (bookId === "psalter") {
